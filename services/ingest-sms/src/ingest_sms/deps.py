...
from ingest_sms.idempotency import IdempotencyCache
...
class IngestDeps:
    settings: Settings
    producer: AvroProducer[SmsEventV1]
...
async def build_deps(
    ...
    *,
    ...
    if idempotency is None:
        from ingest_sms.idempotency import RedisIdempotencyCache
    ...
    producer: AvroProducer[SmsEventV1] = AvroProducer(
...
def deps_dependency(request: Request) -> IngestDeps:
    ...
    if deps is None:
        raise RuntimeError("ingest_sms.deps not initialised")
