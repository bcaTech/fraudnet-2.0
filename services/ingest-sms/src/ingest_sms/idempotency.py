"""Same shape as ingest-momo / ingest-voice."""
...
_log = get_logger("ingest_sms.idempotency")

_DUPLICATES = counter(
    "ingest_sms_duplicates_total",
    "Idempotency duplicates suppressed.",
)
_FALLBACK_OPEN = counter(
    "ingest_sms_idempotency_fallback_open_total",
...
class RedisIdempotencyCache(IdempotencyCache):
    def __init__(self, *, url: str, namespace: str = "sms:idem") -> None:
